...
Skin in the game is an ages old public widsom reformulated by Nassim Nicholas Taleb which boils down to stating that it's easier to trust the outcome of an event if the people involved might face negative consequences in case of failure.
...
- Average edition cost: ~1500 euros
- Mean number of people attending each event: ~300
...
Having a recurring deadline based on a chronological marker has been of the most productive and satisfying changes I have ever implemented in my own life. I think more people could benefit from approaching the issue in the same way with sports, cooking, dancing or DJing. Like most things thought it could become dull over time and one always needs to reinvent the idea from scratch here and there.

If you are interested in participating in those events or just want to send me feedback shoot me an email at **[hello[at]pascal.cc](mailto:hello@pascal.cc)**. Or just let me know if this reaches unprecedented levels of autism.
